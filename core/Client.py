...
from core.function import gather_flat_grad, get_trainable_hyper_params, loss_adjust_cross_entropy
    ...
    def grad_d_out_d_x(self):
        ...
        for batch_idx, (images, labels) in enumerate(self.ldr_val):
            ...
            d_out_d_x += gather_flat_grad(grad(loss,
                                         get_trainable_hyper_params(self.hyper_param), create_graph=True))
